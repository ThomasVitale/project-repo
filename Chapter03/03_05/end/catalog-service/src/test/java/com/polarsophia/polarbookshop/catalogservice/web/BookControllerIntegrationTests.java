...
class BookControllerIntegrationTests {
    ...
    void whenGetRequestWithIdThenBookReturned() {
        ...
        Book expectedBook = new Book(bookIsbn, "Book Title", "Book Author", Year.of(1991));
    ...
    void whenPostRequestThenBookCreated() {
        // Given
        Book expectedBook = new Book("1231231231", "Book Title", "Book Author", Year.of(1991));
    ...
    void whenPutRequestThenBookUpdated() {
        // Given
        Book expectedBook = new Book("1231231232", "Book Title", "Book Author", Year.of(1991));
        ...
        Objects.requireNonNull(createdBook).setPublishDate(Year.of(1990));
        ...
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
        assertThat(response.getBody().getPublishDate()).isEqualTo(Year.of(1990));
    }
    ...
    void whenDeleteRequestThenBookDeleted() {
        ...
        Book expectedBook = new Book(bookIsbn, "Book Title", "Book Author", Year.of(1973));
        restTemplate.postForEntity("/books", expectedBook, Book.class);
