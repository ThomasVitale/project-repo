...
class BookControllerMvcTests {
    ...
    @Test
    void whenDeletingNotExistingBookThenShouldReturn404() throws Exception {
        String isbn = "8924243940";
        given(bookService.removeBookFromCatalog("isbn")).willReturn(Optional.empty());
        mockMvc
                .perform(delete("/books/" + isbn).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound())
                .andExpect(content().string("The book with ISBN " + isbn + " was not found."));
    }
}
