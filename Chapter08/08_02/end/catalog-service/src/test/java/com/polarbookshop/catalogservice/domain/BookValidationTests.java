...
class BookValidationTests {
    ...
    void whenAllFieldsCorrectThenValidationSucceeds() {
        Book book = new Book(1L, "1234567890", "Title", "Author", Year.of(2000), 9.90);
    ...
    void whenIsbnNotDefinedThenValidationFails() {
        Book book = new Book(1L, "", "Title", "Author", Year.of(2000), 9.90);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
    ...
    void whenIsbnDefinedButIncorrectThenValidationFails() {
        Book book = new Book(1L, "a234567890", "Title", "Author", Year.of(2000), 9.90);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
    ...
    void whenTitleIsNotDefinedThenValidationFails() {
        Book book = new Book(1L, "1234567890", "", "Author", Year.of(2000), 9.90);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
        assertThat(violations).hasSize(1);
        assertThat(violations.iterator().next().getMessage())
    ...
    void whenAuthorIsNotDefinedThenValidationFails() {
        Book book = new Book(1L, "1234567890", "Title", "", Year.of(2000), 9.90);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
        assertThat(violations).hasSize(1);
        assertThat(violations.iterator().next().getMessage())
    ...
    void whenPublishDateIsNotDefinedThenValidationSucceeds() {
        Book book = new Book(1L, "1234567890", "Title", "Author", null, 9.90);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
        assertThat(violations).isEmpty();
    }
    ...
    void whenPublishDateIsInTheFutureThenValidationFails() {
        Book book = new Book(1L, "1234567890", "Title", "Author", Year.of(2050), 9.90);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
        assertThat(violations).hasSize(1);
        assertThat(violations.iterator().next().getMessage())
    ...
    void whenPriceIsZeroThenValidationFails() {
        Book book = new Book(1L, "1234567890", "Title", "Author", null, (double) 0);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
        assertThat(violations).hasSize(1);
        assertThat(violations.iterator().next().getMessage())
